	...
	const handleSubmit = (e) => {
		...
		emailjs
			.send(
				...
				{
					from_name: username,
					to_name: "Abhay Varshney",
					reply_to: user_email,
					to_email: "abhay25v@gmail.com",
					message: user_message,
				},
				{publicKey: 'pHAMif6FY61HuMRtV'}
			)
			.then(
				() => {
					setLoading(false);
			...
			<div className='text-white contact overflow-x-hidden pt-12 mt-8 ' id='contact'>
				<div className='z-10 w-full sm:w-[650px] m-auto p-8 rounded-2xl' >
					...
					>
						...
						<button
							type='submit'
							className='py-1 px-8 rounded-xl outline-none w-fit font-bold shadow-md bg-gray-900'
						>
